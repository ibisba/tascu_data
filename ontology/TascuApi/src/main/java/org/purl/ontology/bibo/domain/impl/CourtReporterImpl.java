...
import org.purl.ontology.bibo.domain.CourtReporter;
import org.purl.ontology.bibo.domain.Document;
import org.purl.ontology.bibo.domain.DocumentStatus;
import org.purl.ontology.bibo.domain.LegalDocument;
import org.purl.ontology.bibo.domain.Literature;

/**
 * Code generated from http://purl.org/ontology/bibo/ ontology
 */
public class CourtReporterImpl extends PeriodicalImpl implements CourtReporter {
  public static final String TypeIRI = "http://purl.org/ontology/bibo/CourtReporter";

  protected CourtReporterImpl(Domain domain, Resource resource) {
    super(domain,resource);
  }

  public static CourtReporter make(Domain domain, Resource resource, boolean direct) {
    synchronized(domain) {
      Object toRet = null;
      if(direct) {
        toRet = new CourtReporterImpl(domain,resource);;
      }
      else {
        toRet = domain.getObject(resource,CourtReporter.class);
        if(toRet == null) {
          toRet = domain.getObjectFromResource(resource,CourtReporter.class,false);
          if(toRet == null) {
            toRet = new CourtReporterImpl(domain,resource);;
          }
        }
        else if(!(toRet instanceof CourtReporter)) {
          throw new RuntimeException("Instance of org.purl.ontology.bibo.domain.impl.CourtReporterImpl expected");
        }
      }
      return (CourtReporter)toRet;
    }
  }

  public void validate() {
    super.validate();
    this.checkCardMin1("http://purl.org/ontology/bibo/hasPart");
  }

  public void remHasPart(LegalDocument val) {
    this.remRef("http://purl.org/ontology/bibo/hasPart",val,false);
  }

  public List<? extends LegalDocument> getAllHasPart() {
    return this.getRefSet("http://purl.org/ontology/bibo/hasPart",false,LegalDocument.class);
  }

  public void addHasPart(LegalDocument val) {
    this.addRef("http://purl.org/ontology/bibo/hasPart",val);
  }

  public String getNumVolumes() {
    return this.getStringLit("http://purl.org/ontology/bibo/numVolumes",true);
  }

  public void setNumVolumes(String val) {
    this.setStringLit("http://purl.org/ontology/bibo/numVolumes",val);
  }

  public String getEissn() {
    return this.getStringLit("http://purl.org/ontology/bibo/eissn",true);
  }

  public void setEissn(String val) {
    this.setStringLit("http://purl.org/ontology/bibo/eissn",val);
  }

  public String getIssn() {
    return this.getStringLit("http://purl.org/ontology/bibo/issn",true);
  }

  public void setIssn(String val) {
    this.setStringLit("http://purl.org/ontology/bibo/issn",val);
  }
