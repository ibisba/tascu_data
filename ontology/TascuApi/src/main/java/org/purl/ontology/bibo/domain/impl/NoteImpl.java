...
import org.purl.ontology.bibo.domain.Note;

/**
 * Code generated from http://purl.org/ontology/bibo/ ontology
 */
public class NoteImpl extends DocumentImpl implements Note {
  public static final String TypeIRI = "http://purl.org/ontology/bibo/Note";
    ...
    synchronized(domain) {
      ...
      if(direct) {
        ...
        if(toRet == null) {
          ...
          throw new RuntimeException("Instance of org.purl.ontology.bibo.domain.impl.NoteImpl expected");
        }
      }
      return (Note)toRet;
    }
  ...
  public void remAnnotates(String val) {
    this.remExternalRef("http://purl.org/ontology/bibo/annotates",val,true);
  }

  public List<? extends String> getAllAnnotates() {
    return this.getExternalRefSet("http://purl.org/ontology/bibo/annotates",true);
  }

  public void addAnnotates(String val) {
    this.addExternalRef("http://purl.org/ontology/bibo/annotates",val);
  }
