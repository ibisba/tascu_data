...
import org.purl.ontology.bibo.domain.LegalDecision;
import org.purl.ontology.bibo.domain.Literature;

/**
 * Code generated from http://purl.org/ontology/bibo/ ontology
 */
public class LegalDecisionImpl extends LegalCaseDocumentImpl implements LegalDecision {
  public static final String TypeIRI = "http://purl.org/ontology/bibo/LegalDecision";

  protected LegalDecisionImpl(Domain domain, Resource resource) {
    super(domain,resource);
  }

  public static LegalDecision make(Domain domain, Resource resource, boolean direct) {
    synchronized(domain) {
      Object toRet = null;
      if(direct) {
        toRet = new LegalDecisionImpl(domain,resource);;
      }
      else {
        toRet = domain.getObject(resource,LegalDecision.class);
        if(toRet == null) {
          toRet = domain.getObjectFromResource(resource,LegalDecision.class,false);
          if(toRet == null) {
            toRet = new LegalDecisionImpl(domain,resource);;
          }
        }
        else if(!(toRet instanceof LegalDecision)) {
          throw new RuntimeException("Instance of org.purl.ontology.bibo.domain.impl.LegalDecisionImpl expected");
        }
      }
      return (LegalDecision)toRet;
    }
  }
  ...
  public LegalDecision getAffirmedBy() {
    return this.getRef("http://purl.org/ontology/bibo/affirmedBy",true,LegalDecision.class);
  }

  public void setAffirmedBy(LegalDecision val) {
    this.setRef("http://purl.org/ontology/bibo/affirmedBy",val,LegalDecision.class);
  }

  public LegalDecision getSubsequentLegalDecision() {
    return this.getRef("http://purl.org/ontology/bibo/subsequentLegalDecision",true,LegalDecision.class);
  }

  public void setSubsequentLegalDecision(LegalDecision val) {
    this.setRef("http://purl.org/ontology/bibo/subsequentLegalDecision",val,LegalDecision.class);
  }

  public LegalDecision getReversedBy() {
    return this.getRef("http://purl.org/ontology/bibo/reversedBy",true,LegalDecision.class);
  }

  public void setReversedBy(LegalDecision val) {
    this.setRef("http://purl.org/ontology/bibo/reversedBy",val,LegalDecision.class);
  }

  public Organization getCourt() {
    return this.getRef("http://purl.org/ontology/bibo/court",false,Organization.class);
  }

  public void setCourt(Organization val) {
    this.setRef("http://purl.org/ontology/bibo/court",val,Organization.class);
  }

  public LocalDate getArgued() {
    return this.getDateLit("http://purl.org/ontology/bibo/argued",false);
  }

  public void setArgued(LocalDate val) {
    this.setDateLit("http://purl.org/ontology/bibo/argued",val);
  }
